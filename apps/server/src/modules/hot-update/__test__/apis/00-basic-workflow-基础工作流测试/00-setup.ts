 ...
 * - 创建测试渠道
 *
 * 运行: bun run src/modules/hot-update/__test__/apis/00-basic-workflow-基础工作流测试/00-setup.ts
 */
...
const logger = createTestLogger('BasicWorkflow:00-Setup');

async function main() {
  logger.info('='.repeat(60));
  logger.info('🎯 基础工作流 - 步骤 00: 初始化测试环境');
  logger.info('='.repeat(60));
